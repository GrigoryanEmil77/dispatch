  ...
  <div class="container text-center">
    ...
    <div class="logo-slider-wrapper mt-5">
      <div class="logo-slider">
        ...
        <img src={picture2} alt="Logo 2" class="logo-img" style={{height:"60px"}}/>
        <img src={picture3} alt="Logo 3" class="logo-img" style={{height:"60px"}}/>
        <img src={picture4} alt="Logo 4" class="logo-img" style={{height:"60px"}}/>
        <img src={picture5} alt="Logo 5" class="logo-img" style={{height:"60px"}}/>
        <img src={picture6} alt="Logo 6" class="logo-img" style={{height:"60px"}}/>
        <img src={picture7} alt="Logo 7" class="logo-img" style={{height:"60px"}}/>
        <img src={picture8} alt="Logo 8" class="logo-img" style={{height:"60px"}}/>
        <img src={picture9} alt="Logo 9" class="logo-img" style={{height:"80px"}}/>
        <img src={picture10} alt="Logo 10" class="logo-img" style={{height:"60px"}}/>
