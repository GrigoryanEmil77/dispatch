...
const servicesSchema = new mongoose.Schema({
    ...
    LoadSearch:String,
    Booking:String, BrokerSetup:String, Detention:String,Invoicing:String,Factoring:String,Support:String
  });
  const trucktypesSchema = new mongoose.Schema({
    titleTruck:String, DryVan:String,Reefer:String, BoxTruck:String,Flatbed:String, StepDeck:String,PowerOnlyng:String
  });
  const requestSchema = new mongoose.Schema({
    titlefirst:String, titlesecond:String,
  });
  const customerSchema = new mongoose.Schema({
    titlefirst:String, titlesecond:String,
  });
  const homeSchema = new mongoose.Schema({
    titlesmall:String,titlelarge:String,text:String
  });
  const followSchema = new mongoose.Schema({
    title:String,facelink:String,instagramlink:String,linkedlink:String,
